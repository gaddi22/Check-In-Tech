...
public class LoginScreen extends javax.swing.JFrame {
    ...
    private void loginButtonActionPerformed(java.awt.event.ActionEvent evt) {                                            
        loginMethod(usernameField.getText(), passwordField.getText());                 
    }                                           
    ...
    private void loginMethod(String name, String password){
        if(DBConnector.verifyLogin(usernameField.getText(), passwordField.getText()) == true){ 
        // if(!name.isBlank()){ // Testing Code.
